...
export class ProfilComponent implements OnInit {
  idLekara:number
  user: User = new User();
  lekar:Lekar={firstLogin:false, id:0, radnovreme:"",klinika:{id:0, naziv:"",adresa:"",opis:""},user:{id:0,username:"",lastname:"",adress:"",city:"",country:"",phoneNumber:"",uloga:"",password:"",email:""},opis:"",specijalizacija:"" }
  constructor(private route: ActivatedRoute, private lekarService: LekarService, private dialog: MatDialog) { 
    this.route.parent.params.subscribe(
      (params) => 
      { 
        this.idLekara=params.idl; 
        this.lekarService.getLekar(this.idLekara).subscribe(
          data=>{
            this.lekar = data;
