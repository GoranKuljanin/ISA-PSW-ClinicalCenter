...
insert into tippregleda (naziv,opis,klinika_id) values ('Tip1','Opis1',1);
insert into tippregleda (naziv,opis,klinika_id) values ('Tip2','Opis2',1);
...
insert into zahtevzazakazivanje (odkada,dokada,opis,lekar_id,prihvacen) values('15.3.2020','16.4.2020','Opis zahteva za odsustvo',1,false);
insert into zahtevzazakazivanje (odkada,dokada,opis,lekar_id,prihvacen) values ('12.3.2020','16.3.2020','Opis zahteva za bolovanje',1,false);

insert into termin (datum,vreme) values ('3.02.2020','14:00');
insert into termin (datum,vreme) values ('4.02.2020','14:00');
insert into termin (datum,vreme) values ('5.02.2020','14:00');
insert into termin (datum,vreme) values ('6.02.2020','14:00');
insert into termin (datum,vreme) values ('7.02.2020','14:00');
insert into termin (datum,vreme) values ('8.02.2020','14:00');
insert into termin (datum,vreme) values ('9.02.2020','14:00');
insert into termin (datum,vreme) values ('3.02.2020','10:00');
insert into termin (datum,vreme) values ('3.02.2020','17:00');
insert into termin (datum,vreme) values ('8.02.2020','16:00');
insert into termin (datum,vreme) values ('10.02.2020','16:00');
insert into termin (datum,vreme) values ('11.02.2020','16:00');
insert into termin (datum,vreme) values ('12.02.2020','16:00');
insert into termin (datum,vreme) values ('13.02.2020','16:00');
insert into termin (datum,vreme) values ('14.02.2020','16:00');
...
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 1500.00, 1, 1, 1, 2, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 200.00, 1, 1, 1, 3, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 4000.00, 1, 1, 1, 4, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 1500.00, 1, 1, 1, 5, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 4000.00, 1, 1, 1, 6, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 4000.00, 1, 1, 1, 7, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 1500.00, 1, 1, 1, 8, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 4000.00, 1, 1, 1, 9, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, pacijent_id, klinika_id, termin_id,tippregleda_id) values ('1h', 1, 4000.00, 1, 1, 1, 10, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, klinika_id, termin_id,tippregleda_id) values ('2h', 2, 2000.00, 1, 1, 11, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, klinika_id, termin_id,tippregleda_id) values ('1.5h', 3, 150.00, 1, 1, 12, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, klinika_id, termin_id,tippregleda_id) values ('0.5h', 4, 200.00, 1, 1, 13, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, klinika_id, termin_id,tippregleda_id) values ('1.2h', 1, 300.00, 1, 1, 14, 1);
insert into pregled (trajanje, sala_id, cena, lekar_id, klinika_id, termin_id,tippregleda_id) values ('0.2h', 2, 4000.00, 1, 1, 15, 1);

insert into pregled (trajanje, pacijent_id, cena, lekar_id, klinika_id, termin_id,tippregleda_id) values ('1:1', 2, 4000.00, 1, 1, 5, 1);
