...
public class KlinikaService {
	...
	public Collection<Cena> getCene(Long id) {
		...
		cene.removeIf((Cena c) -> c.getKlinika()!=id);
		return cene;
	}
	...
	public Collection<Lekar> getLekari(Long id) {
		...
		lekari.removeIf((Lekar c) -> c.getKlinika()!=id);
		return lekari;
	}
	...
	public Collection<Termin> getTermini(Long id) {
		...
		termini.removeIf((Termin c) -> c.getKlinika()!=id);
		return termini;
	}
	...
	public Collection<Sala> getSale(Long id) {
		...
		sale.removeIf((Sala c) -> c.getKlinika()!=id);
		return sale;
	}
}
